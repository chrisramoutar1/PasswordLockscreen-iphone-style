...
{ 
   ...
   // basically this has turned it into a string.
   ...
   if(masterTest.equals(masterCode))
   {
    ...
    JOptionPane.showMessageDialog(null, "Password is wrong, sorry! ");
                ...
                //4 is erased so fast you dont see it
                count = 0;
                break;
    ...
    private void initComponents() {
        ...
        getContentPane().add(Clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 370, -1, -1));
